...
const { PaginaNuevaPractica } = await import('./PaginaNuevaPractica')
...
describe('PaginaNuevaPractica', () => {
  ...
  // Los nombres viajan resueltos para que el renglón "En curso" del historial
  // se pinte sin volver a consultar los catálogos.
  test('guardar borrador incluye los nombres de la cabecera, ya resueltos', async () => {
    montar()
    await llenarCabecera()
